    ...
    <div class="mainnavi top" v-if="type === 'top'">
        <ul class="ul">
            ...
            <li class="li h5" @click="choose('archives')"
                ...
                <a class="a" :href="withBase(`/pages/archives`)"><svg class="svg" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
                            d="M3 10H21V20.0044C21 20.5543 20.5551 21 20.0066 21H3.9934C3.44476 21 3 20.5552 3 20.0044V10ZM9 12V14H15V12H9ZM2 3.99981C2 3.44763 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44372 22 3.99981V8H2V3.99981Z"
                            fill="currentColor"></path>
    ...
    <div class="mainnavi left" v-else>
        <ul class="ul">
            ...
            <li class="li" @click="choose(key.toString())"
                ...
                v-for="(item, key) in data"><a class="a" :href="withBase(`/?category=${key.toString()}`)">{{ key
                    }}<strong class="VPBadge tip strong mini">{{ data[key].length }}</strong></a></li>
        </ul>
        ...
        <ul class="ul">
            <!-- <li class="li" @click="choose('feed')"
                ...
                <a class="a" :href="withBase(`/pages/feed`)"><svg class="svg" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="li" @click="choose('tools')"
                :class="{ on: (page.relativePath == 'pages/tools.md' && selected === '') || selected === 'tools' }"><a
                    class="a" :href="withBase(`/pages/tools`)"><svg class="svg" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="li" @click="choose('about')"
                :class="{ on: (page.relativePath == 'pages/about.md' && selected === '') || selected === 'about' }"><a
                    class="a" :href="withBase(`/pages/about`)"><svg class="svg" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
